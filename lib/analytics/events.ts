...
export const E = {
  ...
  // Challenge (blind-compare) funnel
  CHALLENGE_OPENED:                 "challenge_opened",        // client
  CHALLENGE_RANK_STARTED:           "challenge_rank_started",  // client
  CHALLENGE_SKIPPED:                "challenge_skipped",       // client
...
export interface EventProperties {
  ...
  [E.CHALLENGE_OPENED]:                 { listId: number };
  [E.CHALLENGE_RANK_STARTED]:           { listId: number };
  [E.CHALLENGE_SKIPPED]:                { listId: number };

        ...
        <SectionCard title="Your profile">
          <form onSubmit={handleSaveProfile} className="flex flex-col gap-4">
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                type="checkbox"
                className="mt-0.5 h-4 w-4 accent-rk-accent cursor-pointer"
                checked={profilePrivate}
                onChange={(e) => setProfilePrivate(e.target.checked)}
              />
              <span className="flex flex-col gap-1">
                <span className={labelTextCls}>Private profile</span>
                <span className={hintCls}>
                  Hide your profile from search engines and don&apos;t show a
